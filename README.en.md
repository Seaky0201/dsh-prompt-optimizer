...
Author: **啃轮胎的西狐** · Version **0.1.1beta2** · Release date **2026/09/13** (the same credit appears at the bottom of the in-plugin `?` panel)
...
dsh plugin --profile web add github:Seaky0201/dsh-prompt-optimizer#v0.1.1-beta.2
dsh plugin --profile web add ./dsh-external-dsh-prompt-optimizer-0.1.1-beta.2.tgz
